...
site.add(['.css', '.js', '.png', '.jpg', '.webp', '.svg']);

site.process([".md"], (pages) => {
	for (const page of pages) {
		if (!page.sourcePath.startsWith('/updates/content'))
			continue;
...
site.use(google_fonts({
	fonts: "https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap",
	subsets: ["latin"],
	cssFile: '/fonts.css'
}));
